...
public class XScrollList extends JResizer  implements IComponente{
	...
	public XScrollList(String nome) {
		super();
		
		JLabel j = new JLabel("");
		ImageIcon image = new ImageIcon(IPrincipalView.class.getResource("/br/com/virtualsolucoesti/images/list-tela.png")); 
		j.setIcon(image);
		
		this.nome = nome.toLowerCase();
		
		// Verificando itens menus...
				popup.add(new AcaoPopupMenu("Remove TableView") {
					@Override
